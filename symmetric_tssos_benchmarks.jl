...
# symmetry
opt3,data3 = tssos_symmetry(pop, X, r, G; numeq=0, SymmetricConstraint=true, TS=false);
...
# symmetry
opt3,data3 = tssos_symmetry(pop, X, r, G; numeq=1, SymmetricConstraint=true, TS=false);
